...
At this point in the analysis I had not performed a thorough comparison with the statistical methods used in the research paper. 



there was a lot of noise and so the analysis was run again. 
...
In addition to this Github repository and the powerpoint presentation, I created a package called Twenty. The package was named after the group number allocated in the R for Bio Data Science class. This package is available for download from the Github repository at the following link : https://github.com/rforbiodatascience22/Twenty. The package contains four functions and example subset datasets to be used for each function. 
